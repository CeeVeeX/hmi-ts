...
function buildReadBody(options: Mc4eReadOptions): Uint8Array {
...
function buildWriteBody(options: Mc4eWriteOptions): Uint8Array {
  ensureUInt24(options.start, 'start')
...
function mergeReadOptions(options: Mc4eReadOptions[]): Mc4eReadOptions[] {
  if (options.length === 0) {
    return []
  }
